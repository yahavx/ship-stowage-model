*** This is originally an .MD file, can view it nicely here: https://github.com/yahavx/ship-stowage-model/blob/master/README.md
...
`Travel` directory: consists of `Plan`, `Route`, and `.cargo_data` files, in the format explained in: https://docs.google.com/document/d/10dw03hb-mj6zL8O08K5YSm4KYTeIv7eTmckcezrzH_E/edit.
